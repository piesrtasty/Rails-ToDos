...
var BackboneRailsAuthTokenAdapter = {
	//
	// Given an instance of Backbone, route its sync() function so that it executes
	// through this one first, which mixes in the CSRF authenticity token that Rails 3
	// needs to protect requests from forgery. Optionally, the token's name can be
